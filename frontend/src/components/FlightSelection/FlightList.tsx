...
export default function FlightList({ flights, title, selectedFlight, onSelectFlight }: FlightListProps) {
  return (
    <div className="mb-8">
        ...
        flights.map((flight) => (
          <div
            ...
            className={`cursor-pointer transition-all duration-200 ${
              selectedFlight?.id === flight.id ? 'border-2 border-blue-500 shadow-lg' : 'border border-transparent'
            }`}
          >
